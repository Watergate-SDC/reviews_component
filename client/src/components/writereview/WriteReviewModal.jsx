...
export default class WriteReviewModal extends Component {
  ...
  render(){
    ...
    console.log('writereviewmodal', this.props)
    return (
      <div
        className={
      ...
      >
        ...
        <div className="write-review-modal-title">
          <h1>
            <span className="write-review-title">My Review for {data.productTitle}</span>
          </h1>
        </div>
        <div className="write-review-form">
          ...
          <form>
            ...
            <hr className="write-review-hr"></hr>
            ...
            <div className="overall-rating-container">
              ...
              <span className="write-review-average-title"></span>
            </div>
            <hr className="write-review-hr"></hr>
            <div className="write-review-form-title">
              <span> Review Title* </span>
              <input className="write-review-title-input" placeHolder="Example: Great Features!"></input>
            </div>
            <hr className="write-review-hr"></hr>
            <div className="write-review-body-container">
              <span> Review* </span>
              <textarea className="write-review-body" placeHolder="Example: I bought this a month ago and am so happy that I did..."></textarea>
            </div>
            <hr className="write-review-hr"></hr>
            ...
            <div className="write-review-nickname-container">
              ...
              <input className="write-review-nickname-input" placeHolder="Example: jackie27"></input>
            </div>
            <hr className="write-review-hr"></hr>
            <div className="write-review-email-container">
              <span className="write-review-email-title"> Email* </span>
              <input className="write-review-email-input" placeHolder="Example: youremail@example.com"></input>
            </div>
            <hr className="write-review-hr"></hr>
            ...
            <div className="write-review-where-from-container">
              ...
              <input className="write-review-where-from-input"></input>
            </div>
            <hr className="write-review-hr"></hr>
            ...
            <div className="write-review-likes-container">
              ...
              <input className="write-review-likes-input"></input>
            </div>
            <hr className="write-review-hr"></hr>
            <div className="write-review-dislikes-container">
              ...
              <input className="write-review-dislikes-input"></input>
            </div>
            <hr className="write-review-hr"></hr>
            <div className="write-review-terms-agree-container">
              <input className="write-review-terms-agree-checkbox" type="checkbox"></input>
